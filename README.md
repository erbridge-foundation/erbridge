...
ER Bridge is an open-source wormhole mapping tool for EVE Online. Track your chain, tag connections, share situational awareness with your fleet, and never lose your way back to known space again.
...
**We'd love to have you upstream.** If you improve ER Bridge for your group, consider contributing those improvements back to this project. A shared codebase keeps us all synced and makes the tool better for everyone in the community—whether it's a bug fix, a new feature, or a nice-to-have quality-of-life enhancement. Rather than maintaining a fork, let's build together.
...
Inspired by [Tripwire](https://bitbucket.org/daimian/tripwire) and [Wanderer](https://wanderer.ltd/). Special thanks to the wormhole community for keeping J-space weird.
